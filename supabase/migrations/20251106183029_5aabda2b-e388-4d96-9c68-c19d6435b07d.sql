...
DROP POLICY IF EXISTS "Admins can delete scheduled notifications" ON scheduled_notifications;
...
CREATE INDEX IF NOT EXISTS idx_scheduled_notifications_admin_id ON scheduled_notifications(admin_id);
...
DROP POLICY IF EXISTS "Admins can manage own digest preferences" ON admin_digest_preferences;
