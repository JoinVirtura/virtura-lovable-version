...
export function ExportSection() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 animate-fade-in">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          {Object.entries(exportPacks).map(([key, pack]) => (
            <Card 
              key={key}
              className={`p-4 cursor-pointer transition-all duration-200 hover:shadow-lg hover-scale ${
                selectedPack === key 
      ...
      <Card className="p-6 animate-fade-in">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          {Object.entries(aspectRatios).map(([ratio, info]) => (
            <Card 
              key={ratio}
              className={`p-4 cursor-pointer transition-all duration-200 hover-scale ${
      ...
      {/* Export Summary */}
      <Card className="p-6 bg-gradient-to-r from-primary/5 to-secondary/5 animate-scale-in">
      ...
      <Button 
        ...
        className="w-full h-12 text-base bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 hover-scale"
      >
        {isExporting ? (
          <>
