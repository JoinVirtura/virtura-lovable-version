        ...
        <Card className="p-6" id="upgrade-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {plans.map((plan) => (
              ...
              >
                {plan.popular && (
                  <Badge className="absolute -top-3 right-6 bg-gradient-primary">
                    Most Popular
                  </Badge>
                )}
                <div className="space-y-4">
          ...
          <div>
            <h3 className="text-lg font-display font-bold mb-4">One-Time Token Packs</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Need extra tokens? Purchase token packs that never expire.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {tokenPacks.map((pack) => (
                <Card key={pack.tokens} className="p-4 text-center hover:border-primary transition-colors cursor-pointer">
                  <div className="space-y-2">
                    <div className="text-2xl font-bold">{pack.tokens}</div>
