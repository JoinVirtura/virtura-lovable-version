            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-right">{
                  project.avatar?.metadata?.resolution?.includes('4K') || project.avatar?.metadata?.resolution?.includes('2160') ? '4K' :
                  project.avatar?.metadata?.resolution?.includes('1080') ? '1080p' :
                  project.avatar?.metadata?.resolution?.includes('720') ? '720p' :
                  project.avatar?.metadata?.resolution || 'Auto'
                }</span>
              </div>
              <div className="flex justify-between">
