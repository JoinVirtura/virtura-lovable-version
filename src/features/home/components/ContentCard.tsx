...
export const ContentCard = ({ tile, className = "", size = 'md', onDownload, onSave }: ContentCardProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Dynamic Shadow Layer - Lifts with card */}
      <motion.div
        className="absolute -inset-1 rounded-3xl"
        animate={{
          boxShadow: isHovered ? [
            '0 20px 60px -15px rgba(168, 85, 247, 0.5), 0 10px 25px -10px rgba(0, 0, 0, 0.3)',
            '0 30px 80px -20px rgba(168, 85, 247, 0.7), 0 15px 35px -15px rgba(0, 0, 0, 0.4)',
            '0 20px 60px -15px rgba(168, 85, 247, 0.5), 0 10px 25px -10px rgba(0, 0, 0, 0.3)',
