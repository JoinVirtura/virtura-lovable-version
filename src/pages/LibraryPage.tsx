  ...
  const assets: Asset[] = [
    {
      id: 1,
      type: "avatar",
      title: "Jenna - Gaming & Anime Enthusiast",
      date: "2024-01-15",
      format: "PNG",
      tags: ["gaming", "anime", "conversations", "friendly"],
    ...
    },
    {
      id: 2,
      type: "avatar",
      title: "Haley - Fitness & Adventure",
      date: "2024-01-14",
      format: "PNG",
      tags: ["fitness", "gym", "energy", "adventures"],
      thumbnail: "/api/placeholder/300/300",
      quality: 8.7,
      generationTime: "2.1s",
      fileSize: "1.1MB"
    },
    {
      id: 3,
      type: "avatar",
      title: "Lena - Bavarian Soul",
      date: "2024-01-13",
      format: "PNG",
      tags: ["bavarian", "sweet", "relaxed", "connections"],
      thumbnail: "/api/placeholder/300/300",
      quality: 9.0,
      generationTime: "1.8s",
      fileSize: "890KB"
    },
    {
      id: 4,
      type: "avatar",
      title: "Raven - Goth Artist",
      date: "2024-01-12",
      format: "PNG",
      tags: ["goth", "artist", "creative", "dark-humor"],
      thumbnail: "/api/placeholder/300/300",
      quality: 9.5,
      generationTime: "2.5s",
      fileSize: "1.3MB"
    },
    {
      id: 5,
      type: "avatar",
      title: "Sofia - Creative Spirit",
      date: "2024-01-11",
      format: "PNG",
      tags: ["creative", "artistic", "passionate", "vibrant"],
      thumbnail: "/api/placeholder/300/300",
      quality: 8.9,
      generationTime: "2.7s",
      fileSize: "1.4MB"
    },
    {
      id: 6,
      type: "avatar",
      title: "Maya - Adventure Seeker",
      date: "2024-01-10",
      format: "PNG",
      tags: ["free-spirit", "wanderlust", "adventure", "experiences"],
      thumbnail: "/api/placeholder/300/300",
      quality: 9.3,
      generationTime: "2.2s",
      fileSize: "1.0MB"
    },
    {
      id: 7,
      type: "avatar",
      title: "Luna - Mysterious Beauty",
      date: "2024-01-09",
      format: "PNG",
      tags: ["mysterious", "elegant", "sophisticated", "beauty"],
      thumbnail: "/api/placeholder/300/300",
      quality: 9.1,
      generationTime: "2.4s",
      fileSize: "1.2MB"
    },
    {
      id: 8,
      type: "avatar",
      title: "Aria - Natural Grace",
      date: "2024-01-08",
      format: "PNG",
      tags: ["natural", "graceful", "serene", "elegant"],
      thumbnail: "/api/placeholder/300/300",
      quality: 8.8,
      generationTime: "2.0s",
      fileSize: "950KB"
