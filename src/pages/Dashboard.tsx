            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="space-y-6">
                ...
                <Card className="p-6 border-2 hover:border-accent/20 transition-colors bg-gradient-to-br from-card via-card/98 to-card/95">
                  ...
                  <div className="h-[600px] overflow-y-auto scroll-smooth scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/30 transition-colors">
